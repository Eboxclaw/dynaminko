...
/**
 * Toggle variant styles. Extracted from the component file so react-refresh
 * does not bail out on hot reload (Fast Refresh only works when a file
 * exports exclusively components and hooks).
 */
...
/** Inferred variant props type — re-exported so consuming components can use it. */
